...
def test_valid_config_defaults():
    ...
    assert c.max_assets_per_shard == 25
...
def test_load_config_toml_then_env(tmp_path):
    ...
    assert cfg.max_assets_per_shard == 25      # default
