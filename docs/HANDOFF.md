...
- **Venv:** gitignored `.venv` with Python 3.13. Canonical verification:
  `./.venv/bin/pytest -o addopts="" -q` → **1,450 passed** on the POL-14 landing candidate on
  2026-07-11.
...
forecast/component writes. The current candidate passes 1,450 tests; its 27/27 mutation battery has
