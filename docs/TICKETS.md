...
reconciled with YouTrack and the repository on 2026-07-14. Each ticket is self-contained; global
...
| **POL-16** | D3 — shadow-execution and ledger wiring | REVIEWED LANDING CANDIDATE — exact code/test candidate `1ebb026`; 2,121 tests; whole-slice crash/replay/settlement proof; independent review found and closed explicit-rounding and restart-integrity gaps; closing re-review and isolated 8/8 mutation gate pass with zero survivors; owner approved merge; no runtime, deployment, or signing | POL-15 |
...
`POL-15 → POL-16 → POL-17 → POL-18 → ≤2-week paper/shadow run → POL-4 live gate`
