...
| **POL-13** | D4a onward — shadow deployment work-stream | IN PROGRESS — fixed-universe subset TTL restart churn was corrected via PR #32 as `1c4d6cb` (2,311 tests, two closing reviews, 10/10 mutations). Three scheduled live Gamma refreshes passed through the previous 900-second failure boundary on one invocation; POL-17/Hermes remain active+enabled under caps with zero restarts, economic/outbox/raw/auth/memory-pressure events. Continue bounded paper/shadow observation; no live-money authority | POL-11, POL-12 |
