...
| **POL-13** | D4a onward — shadow deployment work-stream | IN PROGRESS — POL-17 first-start gate passed at merge `790ff76`: ~204 seconds, three midpoint intervals, full trade tape, zero raw rows/proposals/outboxes/restarts/errors, 103 MiB peak and zero pressure/OOM; stopped gracefully afterward, both units disabled and Hermes never started; POL-18 first start and enablement remain separate gates | POL-11, POL-12 |
