...
| **POL-13** | D4a onward — shadow deployment work-stream | IN PROGRESS — stopped code/identity/unit install and stopped composite config complete at service checkout `28c3dab`; two independent Polygon 137 providers agree, both units inactive/disabled, no DB/profile/cron/activation; later gates remain | POL-11, POL-12 |
