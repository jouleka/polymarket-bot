...
| **POL-14** | D1 — MarketRegistry from Gamma metadata | OPEN — implemented locally; 1,460 tests and 35/35 mutation gate pass; final independent review and landing pending | POL-13 ingestion substrate |
