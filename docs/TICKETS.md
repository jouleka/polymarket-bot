...
| **POL-13** | D4a onward — shadow deployment work-stream | IN PROGRESS — stopped code/identity/unit install complete at service checkout `28c3dab`; both units inactive/disabled, raw evidence verified, no DB/profile/cron/activation; stopped composite config and later gates remain | POL-11, POL-12 |
