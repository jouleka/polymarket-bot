...
| **POL-17** | D4b — continuous ERS + harness runtime | LOCAL REVIEWED-BUILD CANDIDATE — one-process shared-live-book composition, real safety/registry/resolution/shadow/harness stack, supervised lifecycle, whole-slice restart proof, and 2,205-test mutation checkpoint `8a37f34`; closing review/evidence in progress; not pushed, merged, installed, activated, or deployed | POL-14, POL-15, POL-16; POL-18 later attaches through propose-only transport |
