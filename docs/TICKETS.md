...
| **POL-14** | D1 — MarketRegistry from Gamma metadata | OPEN — implemented locally; 1,446 tests and 26/26 mutation gate pass; final independent review and landing pending | POL-13 ingestion substrate |
