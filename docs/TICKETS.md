...
| **POL-16** | D3 — shadow-execution and ledger wiring | IMPLEMENTED LOCALLY — code/test candidate `ecb87e2`; 2,118 tests, whole-slice crash/replay/settlement proof, and 12/12 local mutation probes pass; independent different-model review and landing remain pending; no runtime, deployment, or signing | POL-15 |
