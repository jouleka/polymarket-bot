...
- **Tests:** `./.venv/bin/pytest -o addopts="" -q` → **1,460 passing, exit 0** on the POL-14 landing
...
implemented on its local landing branch with 1,460 tests passing and a 35/35 mutation battery; its
