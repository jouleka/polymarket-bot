...
- **Tests:** `./.venv/bin/pytest -o addopts="" -q` → **1,445 passing, exit 0** on the POL-14 landing
...
implemented on its local landing branch with 1,445 tests passing and a 25/25 mutation battery; its
